        ...
        <div className="p-8 md:p-12">
          ...
          <div className="border-t border-border pt-8">
            <button
              ...
              className="group flex w-full items-center justify-center gap-3 rounded-lg bg-ink px-6 py-3.5 text-sm font-semibold text-card transition-all duration-300 hover:-translate-y-1 hover:bg-accent hover:shadow-lg active:translate-y-0"
            >
